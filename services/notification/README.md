...
Sends email, push, and SMS notifications to users.
...
- OpenAPI JSON: `http://localhost:3111/openapi.json`

## Health Check

```
GET http://localhost:3111/health
GET http://localhost:3111/health/ready
GET http://localhost:3111/metrics
```
