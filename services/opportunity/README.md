...
Manages sales opportunities and the deal pipeline.
...
- OpenAPI JSON: `http://localhost:3103/openapi.json`

## Health Check

```
GET http://localhost:3103/health
GET http://localhost:3103/health/ready
GET http://localhost:3103/metrics
```
