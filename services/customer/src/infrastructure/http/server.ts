...
import { registerCustomerRoutes } from '../../interface/routes/customer.routes';
import { registerHealthRoutes } from '../../interface/routes/health.routes';

// =============================================================================
// HTTP server assembly for the Customer service.
// =============================================================================
...
export async function buildApp(opts: BuildAppOptions): Promise<FastifyInstance> {
  ...
  await app.register(fastifySwagger, {
    openapi: {
      info: {
        ...
        description: 'Customer account management for the Enterprise AI CRM.',
        version: '1.0.0',
      },
      servers: [{ url: '/api/v1' }],
      components: {
  ...
  await app.register(
    async (api) => registerCustomerRoutes(api, service, authenticate),
