...
Manages organizations and company accounts within the CRM platform.
...
- Swagger UI: `http://localhost:3104/docs`
- OpenAPI JSON: `http://localhost:3104/openapi.json`

## Health Check

```
GET http://localhost:3104/health
GET http://localhost:3104/health/ready
GET http://localhost:3104/metrics
```
