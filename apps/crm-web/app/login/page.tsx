...
// PKCE). For local development it accepts a pasted access token so the app can
// be exercised against the gateway without a full IdP round-trip.
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-md">
      <PageHeader title="Sign in" description="Authenticate to access the CRM." />
      <form
